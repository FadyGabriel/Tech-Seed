      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 items-center gap-12 md:gap-20">
        ...
        >
          ...
          >
            ...
            <span className="text-[#A2BF00] inline-flex items-center gap-2">
              ...
              <img
                src={avatar}
                alt="avatar"
                className="w-10 h-10 sm:w-14 sm:h-14 border-2 border-white"
              />
            </span>
          </h1>
          ...
          <button
            ...
            className="bg-[#1B8354] text-white w-full sm:w-64 h-14 px-6 py-3 rounded-md font-medium cursor-pointer
        ...
        >
          ...
          <div className="relative w-full max-w-xs sm:max-w-md md:max-w-lg">
            {/* Decorative avatars */}
            <img src={avatar1} alt="bg-avatar-1" className="absolute -top-6 left-1/2 -translate-x-1/2 w-10 sm:w-14 h-10 sm:h-14 opacity-70 -z-10" />
            <img src={avatar3} alt="bg-avatar-2" className="absolute top-[30%] -left-3 w-12 sm:w-16 h-12 sm:h-16 opacity-60 -z-10" />
            <img src={avatar2} alt="bg-avatar-3" className="absolute -bottom-6 left-1/2 -translate-x-1/2 w-8 sm:w-12 h-8 sm:h-12 opacity-70 -z-10" />
            ...
            <div className="grid grid-cols-2 gap-4 sm:gap-6 z-10">
              <div className="aspect-square rounded-full bg-[#08A5E4] flex items-center justify-center overflow-hidden">
                <img src={heroGirl} alt="Student" className="md:w-[12rem] w-[8rem] md:h-[16.483rem] object-cover" />
              </div>
