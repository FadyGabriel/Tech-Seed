  ...
  return (
    ...
    >
      ...
      md:-top-[3.563rem]">
        ...
        >
          <p className="md:font-[700] md:leading-[2.75rem] text-2xl relative text-[#1F2A37] sm:left-[-100px] sm:top-[50px] sm:w-[37.25rem]  sm:text-[34px]">
            <span className="text-[#1F2A37]">We dream of</span>
            <span className="text-[#1F2A37]"> better education</span> for all the
