        ...
        >
          {instructors.map((instructor, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="min-w-[90vw] sm:min-w-[20rem] max-w-sm bg-white flex-shrink-0 shadow-[0_0_20px_0_rgba(203,203,203,0.4)] rounded-xl p-6 flex flex-col items-center text-center"
            >
              <img
                src={image}
